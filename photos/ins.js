  ...
  function(module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'http://wx.issmart.com.cn/web/test/wzx/EDM/blogimg/ins-min/' + data.link[i] + '.jpg';
          var src = 'http://wx.issmart.com.cn/web/test/wzx/EDM/blogimg/ins/' + data.link[i];
    ...
    function loadData(success) {
      if (!searchData) {
        ...
        xhr.open('GET', './insv1.json?t=' + +new Date(), true);
